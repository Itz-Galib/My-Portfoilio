...
const Footer = () => {
  return (
    <footer className="relative z-10 px-4 py-8 max-w-5xl mx-auto text-left border-t border-white/10 mt-16">
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
        <div>
          ...
          <p className="text-gray-400 text-xs mt-1">
            Full-Stack & Mobile App Developer | Open for Junior/Trainee
            Roles[cite: 1]
          </p>
        </div>
      ...
      <div className="mt-6 pt-4 border-t border-white/5 text-center text-xs text-gray-500">
        © {new Date().getFullYear()} Md. Luthful Hasan Galib. All rights
        reserved.
      </div>
    </footer>
  );
